...
public class ZcurdHeadController extends BaseController {
    ...
    public void listData() {
        ...
        int i = 0;
        for (String para : properties) {
            if ("form_name".equals(para) || "table_name".equals(para)) {
                symbols[i] = "like";
                values[i] = "%" + values[i] + "%";
            }
            i++;
    ...
    public void update() {
        ...
        Db.tx(new IAtom() {
            ...
            public boolean run() throws SQLException {
                ...
                addOpLog("[在线表单] 修改 " + zcurdHead.getTableName());
                return true;
            }
        });
    ...
    public void genForm() {
        ...
        zcurdService.genForm(tableName, dbSource, type);

        addOpLog("[在线表单] 生成表单" + tableName);
        renderSuccess();
    }
    ...
    public void clearMeta() {
        DbMetaTool.clearMetaDataMap();
        renderSuccess("表单缓存清除完成");
    }
